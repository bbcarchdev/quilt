...
size_t
quilt_urlencode_size(const char *src)
{
	size_t l = 1;
...
size_t
quilt_urlencode_lsize(const char *src, size_t srclen)
{
	size_t l = 1;
...
int
quilt_urlencode(const char *src, char *dest, size_t destlen)
{
...
int
twine_urlencode_l(const char *src, size_t srclen, char *dest, size_t destlen)
{
	static const char *xdigit = "0123456789abcdef";
